...
export default function Sidebar (){
    ...
    return(
        ...
        <div className="sidebar-container">
            ...
            <NavLink to="/home"><li className="sidebar-links"><FontAwesomeIcon icon="fa-solid fa-house" className="sidebar-icons"/><div className="sidebar-title">Home</div></li></NavLink>
